      ...
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-brand hover:bg-brand-dark text-white font-semibold py-2.5 rounded-lg transition-colors mb-4 shadow-sm disabled:opacity-70 flex justify-center items-center"
          >
            {isLoading ? (
              <>
