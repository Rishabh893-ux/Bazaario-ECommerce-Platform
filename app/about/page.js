      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-[#ffe000] to-[#799f0c] py-24 px-6">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 tracking-tight drop-shadow-sm">
            Redefining the <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-yellow-100 to-white drop-shadow-md">E-Commerce Experience</span>
          </h1>
          <p className="text-lg md:text-xl text-cyan-50 max-w-2xl mx-auto leading-relaxed font-medium">
